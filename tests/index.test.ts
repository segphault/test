...
import { APIUserAbortError } from 'petstore-fix';
import { Headers } from 'petstore-fix/core';
...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    test('env variable', () => {
      ...
      const client = new Petstore({ apiKey: 'My API Key', oauthAccessToken: 'My OAuth Access Token' });
  ...
  test('maxRetries option is correctly set', () => {
    ...
    // default
    const client2 = new Petstore({ apiKey: 'My API Key', oauthAccessToken: 'My OAuth Access Token' });
